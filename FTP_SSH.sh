...
sed -i "s/'rsa_cert_file=/etc/ssl/certs/ssl-cert-snakeoil.pem'/'rsa_cert_file=/etc/ssl/certificates/vsftpd.pem'/gI" /etc/vsftpd.conf;
sed -i "s/'rsa_private_key_file=/etc/ssl/private/ssl-cert-snakeoil.key'/'rsa_private_key_file=/etc/ssl/certificates/vsftpd.pem'/gI" /etc/vsftpd.conf;
